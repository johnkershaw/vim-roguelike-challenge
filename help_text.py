...
help_text = {
    ...
    "help": "The :help (or :h) command can give information on many topics. Try:\n:h movement\n:h uk\n:h winning\n:h stairs",
    ...
    "movement":"Use hjkl to move (except for starting class Chaos Wizard).  These can be modified by numbers (e.g. 3l will move right three times) and by d or y (to delete and/or yank instead of (just) moving). In addition, many other vim movement commands are supported, although they generally require an amulet or class ability.\nEach individual *keystroke* takes a turn (with exceptions, see :help turns), so be strategic.\nFor more information, consult a vim tutorial or cheat sheet.",
    "controls":"Use hjkl to move (except for starting class Chaos Wizard).  These can be modified by numbers (e.g. 3l will move right three times) and by d or y (to delete and/or yank instead of (just) moving). In addition, many other vim movement commands are supported, although they generally require an amulet or class ability.\nEach individual *keystroke* takes a turn (with exceptions, see :help turns), so be strategic.\nFor more information, consult a vim tutorial or cheat sheet.\nSee also: \n:help delete\n:help yank\n:help put\n:help look\n:help use",
    ...
    "use":"Type @r to use/consume the item in register r. You can check what items are in what registers in your inventory by typing :reg (or i) to view inventory.",
    ...
    "uk":"If you have a UK keyboard, use :set uk to tell vim \" is shift+2, and @ is shift+' If you don't have a UK keyboard, use :set nouk",
    "cursorkeys":"If you really want to use the arrow keys, turn them on with :set cursorkeys\nIf you've decided to keep your fingers on the home keys and move with hjkl, use :set nocursorkeys",
